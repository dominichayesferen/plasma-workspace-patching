...
int main(int argc, char **argv)
{
    ...
    QCommandLineOption _apply =
        QCommandLineOption(QStringList() << QStringLiteral("a") << _a,
                           i18n("Apply a desktop layout package. This can be the name of a package, or a full path to an installed package, at which point this "
    ...
    if (parser.isSet(_list)) {
        ...
        kcm->load();
        kcm->desktopLayoutSettings()->setLookAndFeelPackage(requestedTheme);
