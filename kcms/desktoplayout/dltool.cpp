...
int main(int argc, char **argv)
{
    ...
    // About data
    KAboutData aboutData("desktoplayouttool",
                         i18n("Desktop Layout Tool"),
                         version,
                         i18n("Command line tool to apply desktop layout packages for changing the desktop layout."),
                         KAboutLicense::GPL,
                         i18n("Copyright 2020, Dominic Hayes"));
    ...
    QCommandLineOption _list = QCommandLineOption(QStringList() << QStringLiteral("l") << _l, i18n("List available desktop layout packages"));
    QCommandLineOption _apply = QCommandLineOption(QStringList() << QStringLiteral("a") << _a, i18n("Apply a desktop layout package"), i18n("packagename"));
    ...
    if (parser.isSet(_list)) {
        ...
        kcm->desktopLayoutSettings()->save();
        kcm->save();
        delete kcm;
    }
