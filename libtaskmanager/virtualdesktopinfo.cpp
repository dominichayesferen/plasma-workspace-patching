...
protected Q_SLOTS:
    void navigationWrappingAroundChanged(const bool &navigationWrappingAround);
};
...
VirtualDesktopInfo::Private::Private()
{
    ...
    QObject::connect(watcher, &QDBusPendingCallWatcher::finished, this, [this](QDBusPendingCallWatcher *watcher) {
        ...
        wrap = reply.value().toBool();
    });

}

void VirtualDesktopInfo::Private::navigationWrappingAroundChanged(const bool &navigationWrappingAround)
{
    if (wrap == navigationWrappingAround) {
        return;
    }
    wrap = navigationWrappingAround;
}
